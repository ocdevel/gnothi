...
export const Events = z.enum([
  ...
  'analyze_get_request',
  'analyze_get_response',
  'analyze_themes_response',
  'analyze_books_response',
  'analyze_question_response',
  'analyze_summarize_response',
  // 'analyze_books_list_request',
  // 'analyze_books_list_response',
  // 'analyze_books_post_request',
  // 'analyze_books_post_response',
  // 'analyze_books_top_request',
  // 'analyze_books_top_response',
