...
export const fields = pgTable("fields", {
	...
	userId: uuid("user_id").references(() => users.id, { onDelete: "cascade" } ),
	influencerScore: doublePrecision("influencer_score").default(0),
	nextPred: doublePrecision("next_pred").default(0),
...
export const entries = pgTable("entries", {
	...
	title: varchar("title"),
	text: varchar("text").notNull(),
	noAi: boolean("no_ai").default(false),
	aiRan: boolean("ai_ran").default(false),
...
export const users = pgTable("users", {
	...
	bio: varchar("bio"),
	isCool: boolean("is_cool").default(false),
	...
	cognitoId: varchar("cognito_id"),
},
(table) => {
	return {
		ixUsersCognitoId: index("ix_users_cognito_id").on(table.cognitoId),
