  ...
  return <Box>
    ...
    <ul>
      ...
      <li><strong>Application</strong> means the software program
        provided by the Company downloaded by You on any electronic device, named Gnothi
      </li>
      ...
      <li><strong>Company</strong> (referred to as either
        ...
        LLC and/or Gnothi,108 West 13th Street, Wilmington, Delaware 19801
      </li>
      ...
      <li className="c0 c12 li-bullet-0"><strong>Website</strong><span className="c7">&nbsp;refers to Gnothi, accessible
        from </span><span className="c17 c7"><a className="c23"
                                                href="https://www.google.com/url?q=https://gnothiai.com&amp;sa=D&amp;source=editors&amp;ust=1682120128973461&amp;usg=AOvVaw2p872Oo-pGYXNcv-B-A6UW"
                                                target="_blank">https://gnothiai.com</a></span><span
    ...
    <p className="c0"><span
      className="c3">We use both session and persistent Cookies for the purposes set out below:</span>
    </p>
    <p className="c0 c4"><span className="c3"></span></p>
    ...
    <ul className="c13 lst-kix_2dghst26axd6-0 start">
      ...
      <li className="c0 c12 li-bullet-0"><span
        className="c3">Protect and defend the rights or property of the Company</span>
      </li>
    ...
    <ul className="c13 lst-kix_1y8l3zvx47ud-0 start">
      ...
      <li className="c0 c6 li-bullet-0"><span className="c7">You may opt-out of certain Google Analytics features through your
        ...
        Google in their Privacy Policy: </span><span className="c17 c7"><a className="c23"
                                                                           href="https://www.google.com/url?q=https://policies.google.com/privacy&amp;sa=D&amp;source=editors&amp;ust=1682120128993173&amp;usg=AOvVaw1777GODHT0jkgZW8k1xyec"
                                                                           target="_blank">https://policies.google.com/privacy</a></span><span
        className="c3">&nbsp;</span></li>
      <li className="c0 c6 li-bullet-0"><span className="c7">For more information on the privacy practices of Google, please visit
        the Google Privacy &amp; Terms web page: </span><span className="c7 c17"><a className="c23"
                                                                                    href="https://www.google.com/url?q=https://policies.google.com/privacy&amp;sa=D&amp;source=editors&amp;ust=1682120128993502&amp;usg=AOvVaw1NPGEjvNwvcbIKA993LKej"
                                                                                    target="_blank">https://policies.google.com/privacy</a></span><span
        className="c3">&nbsp;</span></li>
    </ul>
    <p className="c0 c4"><span className="c3"></span></p>
    ...
    <ul className="c13 lst-kix_872lymmxzxa8-0 start">
      <li className="c0 c6 li-bullet-0"><span
        ...
        className="c23"
        href="https://www.google.com/url?q=https://aws.amazon.com/workmail&amp;sa=D&amp;source=editors&amp;ust=1682120128994383&amp;usg=AOvVaw1RYlaF3LuyFi4F7AOaNVeX"
        target="_blank">https://aws.amazon.com/workmail</a></span><span
        className="c3">&nbsp;</span></li>
    </ul>
    <p className="c0 c4"><span className="c3"></span></p>
    <p><h2>Payments</h2></p>
    ...
    <ul className="c13 lst-kix_6kr4fj5r6gtf-0 start">
      <li className="c0 c6 li-bullet-0"><span
        className="c7">Their Privacy Policy can be viewed at </span><span className="c17 c7"><a
        className="c23"
        href="https://www.google.com/url?q=https://stripe.com/us/privacy&amp;sa=D&amp;source=editors&amp;ust=1682120128995151&amp;usg=AOvVaw0pvydB3k_iu7zHOSlYXsri"
        target="_blank">https://stripe.com/us/privacy</a></span><span
        className="c3">&nbsp;</span></li>
    </ul>
    <p className="c0 c4"><span className="c3"></span></p>
    <p className="c0 c4"><span className="c3"></span></p>
    ...
    <ul className="c13 lst-kix_bcezjntvopjy-1 start">
      ...
      <li className="c0 c6 li-bullet-0"><span
        className="c3">The sources from which the Personal Data was collected</span>
      </li>
      ...
      <li className="c0 c6 li-bullet-0"><span
        className="c3">The specific pieces of Personal Data we collected about You</span>
      </li>
    </ul>
    ...
    <ul className="c13 lst-kix_glrsu53dvnb2-0 start">
      ...
      <li className="c0 c12 li-bullet-0"><span
        className="c3">Or from Our &quot;Do Not Sell My Personal Information&quot; notice
        banner</span></li>
      <li className="c0 c12 li-bullet-0"><span
        className="c3">Or from Our &quot;Do Not Sell My Personal Information&quot;
        link</span></li>
    </ul>
    <p className="c0 c15 c4"><span className="c3"></span></p>
    ...
    <p className="c0"><span className="c7">We do not knowingly solicit data from or market to children under 18 years of age. By
      ...
      under age 18, please contact us at </span><span className="c17 c7"><a className="c23"
                                                                            href="mailto:gnothi@gnothiai.com"
                                                                            target="_blank">gnothi@gnothiai.com</a></span>
    </p>
    ...
    <p className="c0 c4"><span className="c5"></span></p>
    <p className="c0 c4"><span className="c5"></span></p>
    <p className="c0"><span className="c7">If you have any questions about this Privacy Policy, You can contact us via email at </span><span
      className="c17 c7"><a className="c23" href="mailto:gnothi@gnothiai.com"
                            target="_blank">gnothi@gnothiai.com</a></span>
    </p>
  </Box>
}
