...
export const Events = z.enum([
  ...
  'entries_post_response',
  'entries_put_request',
  'entries_put_response',
  ...
  'insights_question_request',
  'insights_question_response',
  'insights_question_final',
  'insights_summarize_request',
  'insights_summarize_response',
  'insights_summarize_final',
  'insights_themes_request',
  'insights_themes_response',
  'insights_themes_final',
